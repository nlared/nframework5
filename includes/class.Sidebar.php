...
class Sidebar{
	...
	function __toString():string{
		...
		$nframework->csss['101']='https://themes.org.ua/pandora/css/index.css';
		$javas->addjs("
...
$nframework->jss['112']='https://vitali.nlared.com/assets/js/custom.js';
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="header-element country-dropdown dropdown-center">
                                    ...
                                    <a href="javascript:void(0);" class="header-link dropdown-toggle"
                                        ...
                                        <img src="../assets/images/flags-img/us_flag.jpg"
                                    ...
                                    <div class="main-header-dropdown dropdown-menu dropdown-menu-end"
                                        ...
                                        <ul class="mb-0">
                                            <li class="dropdown-item mb-1">
                                                <div class="d-flex align-items-center">
                                                    <div class="pe-2">
                                                        <img src="../assets/images/flags-img/india_flag.jpg"
                                            ...
                                            <li class="dropdown-item mb-1">
                                                <div class="d-flex align-items-center">
                                                    <div class="pe-2">
                                                        <img src="../assets/images/flags-img/malaysia.jpg"
                                                            class="rounded-circle country-img" alt="img">
                                                    </div>
                                                    <div class="flex-grow-1">
                                            ...
                                            <li class="dropdown-item mb-1">
                                                <div class="d-flex align-items-center">
                                                    <div class="pe-2">
                                                        <img src="../assets/images/flags-img/italy_flag.jpg"
                                                            class="rounded-circle country-img" alt="img">
                                                    </div>
                                                    <div class="flex-grow-1">
                                            ...
                                            <li class="dropdown-item mb-1">
                                                <div class="d-flex align-items-center">
                                                    <div class="pe-2">
                                                        <img src="../assets/images/flags-img/argentina.jpg"
                                                            class="rounded-circle country-img" alt="img">
                                                    </div>
                                                    <div class="flex-grow-1">
                                            ...
                                            <li class="dropdown-item mb-1">
                                                <div class="d-flex align-items-center">
                                                    <div class="pe-2">
                                                        <img src="../assets/images/flags-img/turkey.jpg"
                                                            class="rounded-circle country-img" alt="img">
                                                    </div>
                                                    <div class="flex-grow-1">
                                ...
                                <div class="header-element dropdown-center cart-dropdown">
                                    ...
                                    <div class="main-header-dropdown dropdown-menu dropdown-menu-end"
                                        ...
                                        <ul class="mb-0 overflow-auto" id="header-cart-items-scroll">
                                            ...
                                            <li class="dropdown-item">
                                                <div class="d-flex align-items-start cart-dropdown-item">
                                                    <img src="../assets/images/products/5.jpg" alt="img"
                                                        class="avatar avatar-md br-5 me-3">
                                                    <div class="flex-grow-1">
                                                        <div
                                                            class="d-flex align-items-start justify-content-between mb-0">
